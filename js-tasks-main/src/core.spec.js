...
describe('Задания core js', () => {
    describe('#isInteger', () => {
        ...
        it('Возвращает false на NaN', () => {
            assert.equal(core.isInteger(NaN), false);
        });

        it('Возвращает false на Infinity', () => {
            assert.equal(core.isInteger(Infinity), false);
        });

        it('Возвращает false на строку, которая выглядит как число', () => {
            assert.equal(core.isInteger('3'), false);
        });
    });
    ...
    describe('#sumTo', () => {
        ...
        it('Возвращает ошибку, если передан null', () => {
            assert.throws(() => core.sumTo(null), Error, 'Input cannot be null', 'При передаче null должно выбрасываться исключение');
        });

        it('Возвращает ошибку, если передан отрицательное число', () => {
            assert.throws(() => core.sumTo(-1), Error, 'Input must be a valid integer');
        });

        it('Возвращает ошибку, если передан нецелый аргумент', () => {
            assert.throws(() => core.sumTo(3.5), Error, 'Input must be a valid integer');
        });
    });
    ...
    describe('#recSumTo', () => {
        ...
        it('Возвращает ошибку при передаче отрицательного числа', () => {
            assert.throws(() => core.recSumTo(-2), Error, 'Input must be a valid integer');
        });
    });
    ...
    describe('#factorial', () => {
        ...
        it('Возвращает 1 для 0', () => {
            assert.equal(core.factorial(0), 1);
        });

        it('Возвращает ошибку при передаче отрицательного числа', () => {
            assert.throws(() => core.factorial(-1), Error, 'Input must be a valid integer');
        });
    });
    ...
    describe('#isBinary', () => {
        ...
        it('Возвращает false на отрицательное число', () => {
            assert.equal(core.isBinary(-2), false);
        });

        it('Возвращает false на дробное число', () => {
            assert.equal(core.isBinary(2.5), false);
        });
    });
    ...
    describe('#fibonacci', () => {
        ...
        it('Возвращает ошибку при передаче отрицательного числа', () => {
            assert.throws(() => core.fibonacci(-1), Error, 'Input must be a valid integer');
        });

        it('Возвращает правильное число для большого n', () => {
            assert.equal(core.fibonacci(50), 12586269025);
        });
    });
